...
export const FeatureMontageScene: React.FC = () => (
  <AbsoluteFill>
    <Sequence name="Up to 325 km WLTP range" durationInFrames={68} premountFor={18}><FeatureCard durationInFrames={68} glyph="325 KM" kicker="UP TO 325 KM WLTP RANGE" line1="GO FARTHER" line2="EVERY DAY" car="emas5/front-right.png" videoTrimBefore={5580} videoPosition="52% 50%" /></Sequence>
