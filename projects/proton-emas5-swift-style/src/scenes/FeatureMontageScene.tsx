...
const FeatureCard: React.FC<FeatureCardProps> = ({glyph, kicker, line1, line2, car, accent = '#b60719'}) => {
  ...
  return (
    <AbsoluteFill>
      ...
      <div style={{position: 'absolute', left: -80, right: -80, bottom: -20, height: 830, overflow: 'hidden', clipPath: 'polygon(0 6%, 100% 0, 100% 100%, 0 100%)', background: 'linear-gradient(180deg, #3b3d43 0%, #17191e 57%, #090a0d 100%)', boxShadow: '0 -22px 60px rgba(43,0,5,0.34)'}}>
      ...
      <div style={{position: 'absolute', bottom: 42, left: 465, display: 'flex', gap: 14, opacity: interpolate(frame, [18, 28, 55, 65], [0, 0.48, 0.48, 0], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp'}), color: 'white', fontSize: 24}}><span>&lsaquo;</span><span>&lsaquo;</span><span>&lsaquo;</span></div>
    </AbsoluteFill>
  );
};
