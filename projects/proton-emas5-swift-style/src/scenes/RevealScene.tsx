...
export const RevealScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      ...
      <div style={{position: 'absolute', left: 180, right: 180, bottom: 400, height: 65, borderRadius: '50%', backgroundColor: 'rgba(0,52,78,0.45)', filter: 'blur(25px)', opacity: interpolate(frame, [5, 24, 82, 98], [0, 0.8, 0.8, 0], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp'}), scale: interpolate(frame, [5, 75], [0.55, 1.08], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp', output: 'perceptual-scale'})}} />
      <Img name="Front reveal" src={staticFile('emas5/front-v8.png')} style={{position: 'absolute', width: 810, height: 'auto', left: '50%', bottom: 380, translate: interpolate(frame, [0, 24, 82, 102], ['-50% 720px', '-50% 0px', '-50% -10px', '-50% 1120px'], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp', easing: Easing.bezier(0.16, 1, 0.3, 1)}), scale: interpolate(frame, [0, 82], [0.68, 1.05], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp', easing: Easing.bezier(0.16, 1, 0.3, 1), output: 'perceptual-scale'}), filter: 'drop-shadow(0 30px 24px rgba(0,0,0,0.42)) brightness(1.025)'}} />
