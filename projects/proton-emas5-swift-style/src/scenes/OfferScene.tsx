...
export const OfferScene: React.FC = () => {
  ...
  return (
    <AbsoluteFill>
      <RacingBackground />
      <div style={{position: 'absolute', left: 165, right: 165, top: 1200, height: 74, borderRadius: '50%', backgroundColor: 'rgba(0,45,67,0.5)', filter: 'blur(24px)', scale: interpolate(frame, [0, 38], [0.5, 1], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp', output: 'perceptual-scale'})}} />
      <Img name="Final front hero" src={staticFile('emas5/front-v8.png')} style={{position: 'absolute', width: 850, height: 'auto', left: '50%', top: 630, translate: `-50% ${suspension}px`, scale: interpolate(frame, [0, 38], [0.72, 1], {extrapolateLeft: 'clamp', extrapolateRight: 'clamp', easing: Easing.bezier(0.16, 1, 0.3, 1), output: 'perceptual-scale'}), filter: 'drop-shadow(0 32px 25px rgba(0,0,0,0.42)) brightness(1.025)'}} />
